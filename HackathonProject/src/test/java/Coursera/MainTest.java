...
@Test(priority=5,dependsOnMethods= {"SearchInHomePage","clickCheckBoxesToViewData"})
...
@Test(priority=6,dependsOnMethods= {"SearchInHomePage"})
...
@Test(priority=7,dependsOnMethods= {"SearchInHomePage","GoToForEnterprises"})
public void GoToForCampus() throws IOException {
	page.goCampus();
	System.out.println("Its clicking on Campus");
}
@Test(priority=8,dependsOnMethods= {"SearchInHomePage","GoToForEnterprises","GoToForCampus"})
...
@Test(priority=9,dataProvider="dp")
